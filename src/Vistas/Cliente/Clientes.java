...
public class Clientes extends javax.swing.JFrame {
    ...
    public Clientes() {
        ...
        ClienteController.mostrarCabecera(TableClient);
    ...
    private void initComponents() {
        ...
        Client.setBackground(new java.awt.Color(254, 235, 241));
        Client.setForeground(new java.awt.Color(255, 255, 255));
        Client.setToolTipText("");
        Client.setPreferredSize(new java.awt.Dimension(806, 500));
        ...
        Client.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 126, -1, 20));

        cbxOrder.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Nombre", "Distrito", "Provincia", "Departamento" }));
        cbxOrder.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxOrderActionPerformed(evt);
            }
        });
        Client.add(cbxOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, 210, 30));
        ...
        Client.add(menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 90, 480));
        ...
        Client.add(DeleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 460, 140, 40));
        ...
        Client.add(EditButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 460, 140, 40));
        ...
        Client.add(LogOutButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 50, -1));
        ...
        Client.add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 580, 30));
        ...
        Client.add(AddButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 460, 140, 40));
        ...
        Client.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 620, 290));
        ...
        Client.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, -1, -1));
        Client.add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 30, 30));
        ...
        Client.add(bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 810, 520));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(Client, javax.swing.GroupLayout.PREFERRED_SIZE, 810, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(Client, javax.swing.GroupLayout.PREFERRED_SIZE, 520, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    private void cbxOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxOrderActionPerformed
        ...
        ClienteController.listar(ClienteController.ordenamiento(index));
    ...
    private void DeleteButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteButtonMouseClicked
        if(!Ven){
            if (ClienteController.Eliminar(TableClient)) {
                txtSearch.setText("Buscar por nombre");
                txtSearch.setForeground(Color.GRAY);
                ClienteController.listar();
            }
        }  else JOptionPane.showMessageDialog(this, "Usted no cuenta con los permisos para realizar esta accion");
    ...
    private void EditButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditButtonMouseClicked
        if (!Ven) {
            EditClient e = new EditClient(ClienteController.SeleccionEdicion(TableClient));
            e.setVisible(true);
            this.dispose();
        } else
            JOptionPane.showMessageDialog(this, "Usted no cuenta con los permisos para realizar esta accion");
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if (!nombre.isEmpty()) {
            ClienteController.listar(ClienteController.busquedaSecuencial(nombre));
        } else {
            ClienteController.listar();
        }
    ...
    private void ClientesButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClientesButtonMouseClicked
       ClientesButton.requestFocusInWindow();
