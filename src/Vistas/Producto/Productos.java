...
public class Productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Users, javax.swing.GroupLayout.DEFAULT_SIZE, 522, Short.MAX_VALUE)
        );
    ...
    private void cbxOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxOrderActionPerformed
        ...
        ProductosController.listar(ProductosController.ordenarProductos(index));
    ...
    private void DeleteButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteButtonMouseClicked
        if (!Ven) {
            if (ProductosController.EliminarUsuario(TableProducts)) {
                txtSearch.setText("Buscar por nombre");
    ...
    private void EditButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditButtonMouseClicked
        if (!Ven) {
            EditProduct e = new EditProduct(ProductosController.SeleccionEdicion(TableProducts));
            e.setVisible(true);
            this.dispose();
        } else
            JOptionPane.showMessageDialog(this, "Usted no cuenta con los permisos para realizar esta accion");
    ...
    private void txtSearchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSearchFocusGained
        if (txtSearch.getText().equals("Buscar por nombre")) { // Si el texto es el placeholder
            txtSearch.setText(""); // Borrar el texto al recibir foco
            txtSearch.setForeground(Color.BLACK); // Cambiar el color del texto
        }
    }//GEN-LAST:event_txtSearchFocusGained

    private void txtSearchFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSearchFocusLost
        if (txtSearch.getText().isEmpty()) {
            txtSearch.setText("Buscar por nombre"); // Restablecer el texto si está vacío
            txtSearch.setForeground(Color.GRAY); // Cambiar el color a gris
        }
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if (!nombre.isEmpty()) {
            ProductosController.listar(ProductosController.busquedaSecuencial(nombre));
        } else {
            ProductosController.listar();
        }
